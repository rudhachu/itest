...
╰───────────────────···•\n ${readMore}`;
		...
		if (
			...
			options.contextInfo.externalAdReply.title = config.LINK_PREVIEW.split(
				/[;,|]/
			)[0];
			options.contextInfo.externalAdReply.body = config.LINK_PREVIEW.split(
				/[;,|]/
			)[1];
